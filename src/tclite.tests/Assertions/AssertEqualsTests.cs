...
namespace TCLite.Framework.Assertions
{
    ...
    public class AssertEqualsTests
    {
        ...
        {
            var expectedMessage =
                "  Expected: " + Double.PositiveInfinity.ToString(CultureInfo.InvariantCulture) + Environment.NewLine +
        ...
        static readonly string POS_INFINITY = Double.PositiveInfinity.ToString(CultureInfo.InvariantCulture);
        static readonly string NEG_INFINITY = Double.NegativeInfinity.ToString(CultureInfo.InvariantCulture);

        [TestCase]
        public void PosInfinityNotEqualsNegInfinity()
        {
            var expectedMessage =
                "  Expected: " + POS_INFINITY + Environment.NewLine +
                "  But was:  " + NEG_INFINITY + Environment.NewLine;
