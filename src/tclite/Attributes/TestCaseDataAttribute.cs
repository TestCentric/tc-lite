...
namespace TCLite
{
    ...
    public class TestCaseDataAttribute : TCLiteAttribute, ITestCaseFactory, IImplyFixture
    {
        ...
        /// <summary>
        /// Gets or sets the category or categories to be associated
        /// with all tests generated by this attribute. May be a single
        /// category or a comma-separated list.
        /// </summary>
        public string Category { get; set; }

        /// <summary>
        /// Gets or sets the description to be used for all tests
            ...
            if (source != null)
            {
                ...
                foreach (object item in source)
                {
                    ...
                    if (this.Description != null)
                        parms.Properties.Set(PropertyNames.Description, this.Description);
