...
{
    /// <summary>
    /// TestCaseDataAttribute indicates the source to be used to
    /// provide test cases for a test method. That source may be
    /// any static field, property or method in the current fixture
    /// or any other class.
    /// </summary>
